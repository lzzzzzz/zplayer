...
public class Controller extends FrameLayout {
    ...
    /**全屏按钮图片*/
    private int id_full_scrren_drawable=R.mipmap.ic_shuffle_grey600_36dp;
    /**音量图片*/
    private int id_voice_drawable= R.mipmap.ic_volume_up_grey600_36dp;
    /**亮度图片*/
    private int id_light_drawable=R.mipmap.ic_wb_sunny_grey600_36dp;
    /**播放按钮图片*/
    private int id_play_drawable=android.R.drawable.ic_media_play;
    /**暂停按钮图片*/
    private int id_wait_drawable=android.R.drawable.ic_media_pause;
    ...
    public void showLigntChange(int persent){
        ...
        iv_changge_media_img.setImageResource(id_light_drawable);
    ...
    public void showVoiceChange(int persent){
        ...
        iv_changge_media_img.setVisibility(VISIBLE);
        tv_show_change_info.setVisibility(VISIBLE);
        iv_changge_media_img.setImageResource(id_voice_drawable);
        tv_show_change_info.setText(persent+"%");
    }
    /**
    ...
    public void updatePausePlay() {
        ...
        if (mPlayerCtrl.isPlaying()) {//正在播放
            mBtnPause.setImageResource(id_wait_drawable);
            pause2.setImageResource(id_wait_drawable);
        } else {//播放暂停
            mBtnPause.setImageResource(id_play_drawable);
            pause2.setImageResource(id_play_drawable);
        }
    }
    ...
    public void updateFullScreen() {
        ...
        if (mPlayerCtrl.isFullScreen()) {
            mBtnFullscreen.setImageResource(id_full_scrren_drawable);
            fullscreen2.setImageResource(id_full_scrren_drawable);
        }
        else {
            mBtnFullscreen.setImageResource(id_full_scrren_drawable);
            fullscreen2.setImageResource(id_full_scrren_drawable);
