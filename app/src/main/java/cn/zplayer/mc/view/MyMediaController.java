...
public class MyMediaController extends MediaController {
    ...
    protected View makeControllerView() {
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("custome_my_media_controller_view", "layout", getContext().getPackageName()), this);
